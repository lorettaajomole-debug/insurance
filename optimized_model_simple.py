...
# Model 3: Random Forest with Tuned Parameters (no parallelization)
print("\n" + "="*70)
...
# Model 5: Lasso Regression on Scaled Features
print("\n" + "="*70)
print("MODEL 5: LASSO REGRESSION (SCALED)")
print("="*70)

lasso = Lasso(alpha=10.0)
lasso.fit(X_train_scaled, y_train_orig)
y_pred_lasso = lasso.predict(X_test_scaled)
rmse_lasso = np.sqrt(mean_squared_error(y_test_orig, y_pred_lasso))
r2_lasso = r2_score(y_test_orig, y_pred_lasso)
